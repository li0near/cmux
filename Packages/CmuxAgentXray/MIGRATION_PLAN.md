...
| 2026-06-06 | 19g | `572f65513` (reverted) | Tier 1 of next-session-handover (T1.1) attempted: Grep tool icon swapped to `questionmark.text.page` / `.fill`. **Reverted by user preference** — the original `text.magnifyingglass` glyph reads cleaner. Net effect on Grep icon: zero. |
